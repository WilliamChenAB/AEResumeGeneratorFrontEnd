  ...
  return(
    <>
      <Box sx={{display: 'flex', flexDirection: 'row' }}>
        ...
        {
          activeEmployeeTab !== -1 && mockWorkspaces[workspaceId] && entries[activeEmployeeTab]? <SideBar2 title={entries[activeEmployeeTab].name} color='secondary' setTab={setActiveSectorTypeTab} useButton={true} buttonText='Add Sector' buttonClick={()=>{}} entries={getResumeEntries()}></SideBar2>
          : null
        }
      </Box>
